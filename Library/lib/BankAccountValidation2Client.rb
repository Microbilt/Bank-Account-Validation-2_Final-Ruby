...
module BankAccountValidation
  class BankAccountValidation2Client
    attr_reader :authorization, :ach_check_prescreen_light_client, :base_uri
    ...
    def initialize(client_id, client_secret, environment_type = EnvironmentType::Production)
      ...
      @ach_check_prescreen_light_client = BankAccountValidation::APIClients::ACHCheckPrescreenLiteClient.new(@authorization, @base_uri)
    end
